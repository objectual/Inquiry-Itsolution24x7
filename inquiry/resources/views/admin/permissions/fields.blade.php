...
<div class="form-group col-sm-6">
    ...
    {{ Form::text('moduleName', old('module'), $attributes = ['class'=>'form-control', 'id'=>'module-name', 'placeholder'=>'Module Name', 'required', isset($module_data->name)?'readonly':'', 'autofocus']) }}
...
<div class="form-group col-sm-3">
    {!! Form::label('menu', 'Add In Menu:') !!}
    <div class="clearfix"></div>
    {!! Form::hidden('add_menu', 0) !!}
    {!! Form::checkbox('add_menu', 1, false, ['data-toggle'=>'toggle']) !!}
</div>
