...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('customer_id', $customer, null, ['class' => 'form-control select2', 'placeholder'=>'Add Customer']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder'=>'Enter discount']) !!}
</div>
<!-- Submit Field -->
<div class="form-group col-sm-12">
